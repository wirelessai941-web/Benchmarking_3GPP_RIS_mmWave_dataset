...
# MODEL_PATH = "./outputs/mlp_kl_div_36feat_best.pt"
MODEL_PATH = "/media/corsair/New Volume/wirelessdataset/outputs/mlp_kl_div_36feat_best.pt"

# 🔥 NEW SAVE DIR
TEST_SAVE_DIR = "/media/corsair/New Volume/wirelessdataset/outputs/test"
os.makedirs(TEST_SAVE_DIR, exist_ok=True)

RESULT_FILE = os.path.join(TEST_SAVE_DIR, "test_results.txt")
CSV_FILE    = os.path.join(TEST_SAVE_DIR, "test_predictions.csv")
...
def test():
    ...
    print(f"✅ Results saved in: {TEST_SAVE_DIR}")
